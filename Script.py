...
Nᴏᴛᴇ :- Yᴏᴜ Asᴋ Mᴏᴠɪᴇs Aғᴛᴇʀ Oɴʟʏ  [𝟶𝟷/𝟶𝟺/𝟸𝟶𝟸𝟺 ] Bᴇᴄᴀᴜsᴇ Tʜɪs Is Bᴏᴛ Cʀᴇᴀᴛᴇᴅ Sᴀᴍᴇ Dᴀᴛᴇ 🌹</b>"""
    
    HELP_TXT = "Hᴇʏ {}\nHᴇʀᴇ Mꜱ Mʏ Hᴇʟᴩ"

    ABOUT_TXT = """<b>✯ Mʏ ɴᴀᴍᴇ: {}
✯ Dᴇᴠᴇʟᴏᴩᴇʀ: <a herf=https://t.me/TheBlackXYZ>Itz_.rohan_24</a>
✯ Cᴏᴅᴇᴅ Oɴ: ᴩʏᴛʜᴏɴ/ᴩʏʀᴏɢʀᴀᴍ
✯ Mʏ DᴀᴛᴀBᴀꜱᴇ: ᴍᴏɴɢᴏ-ᴅʙ
✯ Mʏ Sᴇʀᴠᴇʀ: ᴀɴʏᴡʜᴇʀᴇ
✯ Mʏ Vᴇʀꜱɪᴏɴ: Tʜᴇ Bʟᴀᴄᴋ Bᴏᴛ ᴠ4.5.0</b>"""
   
    SOURCE_TXT = """<b>NOTE:</b>
- ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ʜᴇʀᴇ ◉› :<a href=https://github.com/TheBlackxyz/PROFESSOR-BOT>𝐏𝐑𝐎𝐅𝐄𝐒𝐒𝐎𝐑-𝐁𝐎𝐓</a>
